...
//
//   const searchCountrysresponse = Convert.toSearchCountrysresponse(json);
//
...
export class Convert {
    public static toSearchCountrysresponse(json: string): Country[] {
        return cast(JSON.parse(json), a(r("SearchCountrysresponse")));
    }

    public static searchCountrysresponseToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("SearchCountrysresponse"))), null, 2);
    }
}
